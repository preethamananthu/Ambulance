  ...
  return (
    ...
    lg:flex-row lg:justify-around items-center p-6 md:p-20 m-4">
      ...
      <div className="flex flex-col font-semibold">
        <Link href="/driverLogin" className="py-2 px-4 border-2 border-black rounded-full m-1 text-center hover:bg-neutral-600 hover:text-white">
          Driver's portal
        </Link>
        <Link href="/userLogin" className="py-2 px-4 border-2 border-black rounded-full m-1 text-center hover:bg-neutral-600 hover:text-white">
          Customer's portal
        </Link>
      </div>
